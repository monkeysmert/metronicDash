                  ...
                  onChange={() =>
                    updateData({
                      setupEmailNotifications: {
                        ...
                        emailNotifications: !data.setupEmailNotifications
                          .emailNotifications
                      }
                    })
                  }
                ...
                <input
                  ...
                  onChange={() =>
                    updateData({
                      setupEmailNotifications: {
                        ...data.setupEmailNotifications,
                        sendCopyToPersonalEmail: !data.setupEmailNotifications
                  ...
                  onChange={() =>
                    updateData({
                      activityRelatedEmail: {
                        ...
                        whenToEmail: {
                          ...data.activityRelatedEmail.whenToEmail,
                          youHaveNewNotifications: !data.activityRelatedEmail
                            .whenToEmail.youHaveNewNotifications
                        }
                      }
                    })
                  }
                  ...
                  onChange={() =>
                    updateData({
                      activityRelatedEmail: {
                        ...
                        whenToEmail: {
                          ...data.activityRelatedEmail.whenToEmail,
                          youAreADirectMessage: !data.activityRelatedEmail
                            .whenToEmail.youAreADirectMessage
                        }
                      }
                    })
                  }
                  ...
                  onChange={() =>
                    updateData({
                      activityRelatedEmail: {
                        ...
                        whenToEmail: {
                          ...data.activityRelatedEmail.whenToEmail,
                          someoneAddsYouAsAConnection: !data
                            .activityRelatedEmail.whenToEmail
                            .someoneAddsYouAsAConnection
                        }
                      }
                    })
                    ...
                    updateData({
                      activityRelatedEmail: {
                        ...
                        whenToEscalateEmails: {
                          ...
                          uponNewOrder: !data.activityRelatedEmail
                  ...
                  onChange={() =>
                    updateData({
                      activityRelatedEmail: {
                        ...
                        whenToEscalateEmails: {
                          ...data.activityRelatedEmail.whenToEscalateEmails,
                          newMembershipApproval: !data.activityRelatedEmail
                            .whenToEscalateEmails.newMembershipApproval
                        }
                      }
                    })
                  }
                  ...
                  onChange={() =>
                    updateData({
                      activityRelatedEmail: {
                        ...
                        whenToEscalateEmails: {
                          ...data.activityRelatedEmail.whenToEscalateEmails,
                          memberRegistration: !data.activityRelatedEmail
                            .whenToEscalateEmails.memberRegistration
                        }
                      }
                    })
                  }
                  ...
                  onChange={() =>
                    updateData({
                      updatesFromKeenthemes: {
                        ...
                        newsAboutKTProducts: !data.updatesFromKeenthemes
                          .newsAboutKTProducts
                      }
                    })
                  }
                ...
                <input
                  ...
                  onChange={() =>
                    updateData({
                      updatesFromKeenthemes: {
                        ...data.updatesFromKeenthemes,
                        tipsOnGettingMore: !data.updatesFromKeenthemes
                          .tipsOnGettingMore
                      }
                    })
                  }
                ...
                <input
                  ...
                  onChange={() =>
                    updateData({
                      updatesFromKeenthemes: {
                        ...data.updatesFromKeenthemes,
                        newsAboutKTPartners: !data.updatesFromKeenthemes
                          .newsAboutKTPartners
                      }
                    })
                  }
